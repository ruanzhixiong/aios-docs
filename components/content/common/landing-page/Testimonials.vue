<template>
  <div class="flex w-full max-w-7xl flex-col items-center justify-center p-4">
    <div class="py-12 text-5xl font-semibold">丰富的插件生态 <span class="text-4xl"> ❤️</span></div>
    <div
    ...
    >
      ...
      >
        <h3 class="mb-2 text-4xl font-bold sm:text-5xl">还在等什么？</h3>
        <p class="m-4 text-base sm:text-lg">开始构建你的应用吧！</p>
        <NuxtLink to="getting-started/installation">
          <UiButton variant="default"> 开始使用 → </UiButton>
        </NuxtLink>
      </div>
